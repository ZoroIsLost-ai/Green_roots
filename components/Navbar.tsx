  ...
  return (
    <header className="border-b border-surface-border bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 sticky top-0 z-10">
      <div className="mx-auto flex max-w-4xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <Link
          href="/admin"
          className="rounded-xl border border-surface-border bg-white px-3.5 py-1.5 text-xs font-semibold text-ink-muted transition-colors hover:bg-surface-soft hover:text-ink active:scale-[0.98]"
        >
